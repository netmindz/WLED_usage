    ...
    fun recordUpgradeEvent(request: UpgradeEventRequest, countryCode: String?) {
        ...
        val device = existingDevice.orElse(
            Device(
                ...
                ledFeatures = request.ledFeatures?.joinToString(","),
                peripherals = request.peripherals?.joinToString(","),
                integrations = request.integrations?.joinToString(","),
        ...
        device.ledFeatures = request.ledFeatures?.joinToString(",")
        device.peripherals = request.peripherals?.joinToString(",")
        device.integrations = request.integrations?.joinToString(",")
